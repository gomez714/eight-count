...
| [lib/threads/get-unread-comment-count.ts](lib/threads/get-unread-comment-count.ts) | `getUnreadCommentCountForUser(userId)` — dashboard chip number. See "Note threads → Dashboard unread surfacing" above. |
